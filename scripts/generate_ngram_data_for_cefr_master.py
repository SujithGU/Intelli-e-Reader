...
if __name__ == '__main__':
    ...
    ngram = NgramGenerator(file_location=f'{Config.PROJECT_ROOT_FOLDER}/data_files/master_cefr.csv',
                           word_string='word',
                           pos_string='pos',
                           save_location=f'{Config.PROJECT_ROOT_FOLDER}/data_files/master_cefr_with_ngram.csv')
