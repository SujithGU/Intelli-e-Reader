...
class Predictor:
    ...
    def __init__(self):
        ...
        self.sub_optimal_classifier = pickle.load(
            open(f'{Config.PROJECT_ROOT_FOLDER}/model/optimal_models/sub_optimal_classifier2.pkl', 'rb'))

        self.nn_model = tf.keras.models.load_model(
            f'{Config.PROJECT_ROOT_FOLDER}/model/optimal_models/sub_optimal_nn_model2.h5')

        self.optimal_classifier = pickle.load(
            open(f'{Config.PROJECT_ROOT_FOLDER}/model/optimal_models/optimal_classifier_final.pkl', 'rb'))
    ...
    def predict(self, word=None, pos=None):
        ...
        #     f'{Config.PROJECT_ROOT_FOLDER}/model/optimal_models/optimal_nn_model_final.h5')
        #
