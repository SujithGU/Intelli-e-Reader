...
def train_on_nn_network(train_x, test_x, train_y, test_y, model_name="dummy"):
    call_backs = [tf.keras.callbacks.ModelCheckpoint(f'{Config.PROJECT_ROOT_FOLDER}/model/{model_name}_weights.h5',
    ...
    ml_model.save(f'{Config.PROJECT_ROOT_FOLDER}/model/{model_name}.h5')
...
if __name__ == '__main__':
    ...
    pickle.dump(classifier, open(f'{Config.PROJECT_ROOT_FOLDER}/model/sub_optimal_classifier2.pkl', 'wb'))
    ...
    sub_optimal_classifier = pickle.load(open(f'{Config.PROJECT_ROOT_FOLDER}/model/sub_optimal_classifier2.pkl', 'rb'))

    Y_RF = sub_optimal_classifier.predict(X)

    nn_model = tf.keras.models.load_model(f'{Config.PROJECT_ROOT_FOLDER}/model/sub_optimal_nn_model2.h5')
    ...
    pickle.dump(classifier_new, open(f'{Config.PROJECT_ROOT_FOLDER}/model/optimal_classifier.pkl', 'wb'))
    ...
    optimal_classifier = pickle.load(
        open(f'{Config.PROJECT_ROOT_FOLDER}/model/optimal_classifier.pkl', 'rb'))

    Y_RF = optimal_classifier.predict(X_new)

    nn_model_optimal = tf.keras.models.load_model(f'{Config.PROJECT_ROOT_FOLDER}/model/optimal_nn_model3.h5')
    ...
    pickle.dump(classifier_f,
                open(f'{Config.PROJECT_ROOT_FOLDER}/model/optimal_models/optimal_classifier_final.pkl', 'wb'))
