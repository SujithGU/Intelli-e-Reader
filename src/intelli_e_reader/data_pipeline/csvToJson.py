...
'''
# convert_to_json('/data/', oldFileName='master_cefr.csv',newFileName='master_cefr.json')

convertToJsonFile('/data/', oldFileName='SynListThesaurus.csv', newFileName='ThesaurusDict.json')