...
df1 = pd.read_csv('../data/word_pos_modified_data.csv')
df2 = pd.read_csv('../data/modified_scrap_data.csv')
df = pd.read_csv('../data/SynListSynonyms.csv', usecols=cols_to_use)
